...
API_KEY="pk1_69f7d589526e56561e8aab994ed6a838cdb470d3ee288d131d4e5019d7620055"  # Sostituisci con la tua API key Porkbun
SECRET_API_KEY="sk1_b86bbab586acd5fa65da712269547eb227d2b0cdca520a0d83114eacc0e89241"  # Sostituisci con la tua secret API key Porkbun
...
if [ "$CHANGED" = true ]; then
    sudo evernode applyssl /home/evernode/current-certs/privatekey.pem /home/evernode//current-certs/publickey.pem /home/evernode//current-certs/certificatechain.pem
